<section class="w-full">
    <x-page-heading>
        <x-slot:title>My Transactions</x-slot:title>
    </x-page-heading>
    ...
    <x-table>
        <x-slot:head>
            <x-table.row>
                ...
                <x-table.heading>Receipt</x-table.heading>
            </x-table.row>
        </x-slot:head>
        <x-slot:body>
            @foreach($transactions as $trx)
                <x-table.row>
                    ...
                    <x-table.cell>
                        <flux:button href="{{ route('cashier.transactions.receipt', $trx) }}" icon="printer" size="sm">
                            Print
                        </flux:button>
                    </x-table.cell>
                </x-table.row>
