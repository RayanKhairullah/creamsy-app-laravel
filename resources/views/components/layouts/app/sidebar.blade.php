    ...
    <flux:navlist variant="outline">
        @can('access dashboard admin')
            <flux:navlist.group heading="Admin" class="grid">
                <flux:navlist.item icon="home" :href="route('admin.index')" :current="request()->routeIs('admin.index')">Admin Dashboard</flux:navlist.item>
            </flux:navlist.group>
        @endcan
        @can('access dashboard manager')
            <flux:navlist.group heading="Manager" class="grid">
                <flux:navlist.item icon="layout-grid" :href="route('manager.index')" :current="request()->routeIs('manager.index')">Dashboard</flux:navlist.item>
                @can('view products')
                    <flux:navlist.item icon="cube" :href="route('manager.products.index')" :current="request()->routeIs('manager.products.*')">Products</flux:navlist.item>
                @endcan
                @can('view discounts')
                    <flux:navlist.item icon="tag" :href="route('manager.discounts.index')" :current="request()->routeIs('manager.discounts.*')">Discounts</flux:navlist.item>
                @endcan
                @can('view transactions')
                    <flux:navlist.item icon="document-text" :href="route('manager.transactions.index')" :current="request()->routeIs('manager.transactions.*')">Transactions</flux:navlist.item>
                    <flux:navlist.item icon="chart-bar" :href="route('manager.reports.index')" :current="request()->routeIs('manager.reports.*')">Reports</flux:navlist.item>
                @endcan
            </flux:navlist.group>
        @endcan
