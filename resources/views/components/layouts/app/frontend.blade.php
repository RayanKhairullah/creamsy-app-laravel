...
<flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
    ...
    <flux:navbar class="-mb-px max-lg:hidden">
        @can('view products')
            <flux:navbar.item icon="shopping-cart" href="{{ route('cashier.pos') }}" :current="request()->routeIs('cashier.pos')">
                POS
            </flux:navbar.item>
        @endcan
        @can('view transactions')
            <flux:navbar.item icon="document-text" href="{{ route('cashier.transactions.index') }}" :current="request()->routeIs('cashier.transactions.index')">
                Transaction History
            </flux:navbar.item>
        @endcan
    </flux:navbar>
        ...
        <flux:dropdown position="top" align="end">
            ...
            <flux:menu>
                ...
                @can('access dashboard manager')
                    <flux:menu.separator/>
                    <flux:menu.radio.group>
                        <flux:menu.item href="{{ route('manager.index') }}" icon="shield">
